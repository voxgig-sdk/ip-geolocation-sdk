...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_ip_geolocation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.IpGeolocationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation_list",
		Description: "List records from IpGeolocation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ip-geolocation_load",
		Description: "Load a single record from IpGeolocation. " +
...
func runOp(client *sdk.IpGeolocationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.IpGeolocationSDK, name string) (sdk.IpGeolocationEntity, error) {
	switch strings.ToLower(name) {
	case "get_ip_geolocation":
		return client.GetIpGeolocation(nil), nil
