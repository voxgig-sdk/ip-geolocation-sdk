// Command IpGeolocation-mcp is an MCP server exposing the IpGeolocation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	IpGeolocation_list  — list records of an entity
//	IpGeolocation_load  — load a single record of an entity
//
