# IpGeolocation Golang SDK Reference

Complete API reference for the IpGeolocation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IpGeolocationSDK`
...
#### `GetIpGeolocation(data map[string]any) IpGeolocationEntity`
