...
type GetIpGeolocationEntity struct {
	name    string
	client  *core.IpGeolocationSDK
...
func NewGetIpGeolocationEntity(client *core.IpGeolocationSDK, entopts map[string]any) *GetIpGeolocationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetIpGeolocationEntity) GetName() string { return e.name }
...
func (e *GetIpGeolocationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetIpGeolocationEntity) Deleted() bool {
	return e.deleted
}


func (e *GetIpGeolocationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetIpGeolocationEntity(e.client, opts)
}

func (e *GetIpGeolocationEntity) Data(args ...any) any {
...
func (e *GetIpGeolocationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetIpGeolocation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetIpGeolocationEntity) DataTyped(data ...GetIpGeolocation) GetIpGeolocation {
	if len(data) > 0 {
		return typedFrom[GetIpGeolocation](e.Data(asMap(data[0])))
	}
	return typedFrom[GetIpGeolocation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetIpGeolocation (all fields
// optional at the wire level).
func (e *GetIpGeolocationEntity) MatchTyped(match ...GetIpGeolocation) GetIpGeolocation {
	if len(match) > 0 {
		return typedFrom[GetIpGeolocation](e.Match(asMap(match[0])))
	}
	return typedFrom[GetIpGeolocation](e.Match())
}
...
func (e *GetIpGeolocationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetIpGeolocationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetIpGeolocationLoadMatch and returns an GetIpGeolocation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetIpGeolocationEntity) LoadTyped(reqmatch GetIpGeolocationLoadMatch, ctrl map[string]any) (GetIpGeolocation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetIpGeolocation{}, err
	}
	return typedFrom[GetIpGeolocation](res), nil
}



func (e *GetIpGeolocationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetIpGeolocationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetIpGeolocationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetIpGeolocationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetIpGeolocationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
