...
func (sdk *IpGeolocationSDK) OptionsMap() map[string]any {
...
func (sdk *IpGeolocationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IpGeolocationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IpGeolocationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IpGeolocationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IpGeolocationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IpGeolocationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IpGeolocationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IpGeolocationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IpGeolocationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *IpGeolocationSDK {
	...
	sdk := NewIpGeolocationSDK(sdkopts)
	sdk.Mode = "test"
