# IpGeolocation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IpGeolocationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IpGeolocationSDK(...) and IpGeolocationSDK.test(...) become
#      IpGeolocationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ipgeolocation_sdk"
_SDK_CLASS = "IpGeolocationSDK"
