...
from ipgeolocation_sdk.utility import register

# Load features
from ipgeolocation_sdk.feature.base_feature import IpGeolocationBaseFeature
from ipgeolocation_sdk.features import _has_feature, _make_feature
...
class IpGeolocationSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = IpGeolocationUtility()
        self._utility = utility

        from ipgeolocation_sdk.config import shared_config
    ...
    def get_utility(self):
        return IpGeolocationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IpGeolocationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetIpGeolocation(self, data=None) -> "GetIpGeolocationEntity":
        ...
        from ipgeolocation_sdk.entity.get_ip_geolocation_entity import GetIpGeolocationEntity
