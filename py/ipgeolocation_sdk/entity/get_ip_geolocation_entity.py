...
from ipgeolocation_sdk.ipgeolocation_types import (
    GetIpGeolocation,
...
class GetIpGeolocationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetIpGeolocationEntity(self._client, opts)
    ...
    def data_get(self) -> GetIpGeolocation:
    ...
    def match_get(self) -> GetIpGeolocation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetIpGeolocation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetIpGeolocation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
