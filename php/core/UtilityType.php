...
// IpGeolocation SDK utility type

class IpGeolocationUtility
{
    ...
    public static function copy(IpGeolocationUtility $src): IpGeolocationUtility
    {
        $u = new IpGeolocationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
