...
class IpGeolocationTestRunner
{
    ...
    {
        $live = self::getenv('IP_GEOLOCATION_TEST_LIVE');
        $override = self::getenv('IP_GEOLOCATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('IP_GEOLOCATION_TEST_EXPLAIN');
...
class_alias('IpGeolocationTestRunner', 'Runner');
class_alias('IpGeolocationHelpers', 'Helpers');
