...
// IpGeolocation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IpGeolocationSDK::test)
...
{
    private const SDK_CLASS = 'IpGeolocationSDK';
    ...
    private const SDK_BASE = 'ipgeolocation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../ipgeolocation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
