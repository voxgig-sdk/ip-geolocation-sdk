...
// IpGeolocation SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class IpGeolocationTransformResponse
{
    public static function call(IpGeolocationContext $ctx): mixed
    {
        ...
        $transform = IpGeolocationHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
