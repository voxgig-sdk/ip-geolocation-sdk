...
// IpGeolocation SDK debug feature
...
class IpGeolocationDebugFeature extends IpGeolocationBaseFeature
{
    ...
    private function _finish(IpGeolocationContext $ctx, bool $ok): void
    {
