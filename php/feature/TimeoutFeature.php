...
// IpGeolocation SDK timeout feature
...
class IpGeolocationTimeoutFeature extends IpGeolocationBaseFeature
{
    ...
    private function _with_timeout(IpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IpGeolocationContext $_ctx, float $ms): void
    {
        $client = $this->client;
