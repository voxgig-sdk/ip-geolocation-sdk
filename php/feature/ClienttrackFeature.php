...
// IpGeolocation SDK clienttrack feature
...
class IpGeolocationClienttrackFeature extends IpGeolocationBaseFeature
{
    ...
    public function PostConstruct(IpGeolocationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IpGeolocation-SDK';
