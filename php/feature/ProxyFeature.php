...
// IpGeolocation SDK proxy feature
...
class IpGeolocationProxyFeature extends IpGeolocationBaseFeature
{
    ...
    public function init(IpGeolocationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IpGeolocationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
