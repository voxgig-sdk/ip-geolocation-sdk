...
// IpGeolocation SDK audit feature
...
class IpGeolocationAuditFeature extends IpGeolocationBaseFeature
{
    ...
    private function _emit(IpGeolocationContext $ctx, string $outcome): void
    {
