...
// IpGeolocation SDK paging feature
...
class IpGeolocationPagingFeature extends IpGeolocationBaseFeature
{
    ...
    private function _is_list(IpGeolocationContext $ctx): bool
    {
