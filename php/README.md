...
The PHP SDK for the IpGeolocation API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetIpGeolocation(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->IpGeolocation(null)->load(
    ["id" => "test01"], null
);
