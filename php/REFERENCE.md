# IpGeolocation PHP SDK Reference

Complete API reference for the IpGeolocation PHP SDK.
...
#### `IpGeolocationSDK::test($testopts = null, $sdkopts = null)`
