...
func registerSDKWords(r *eng.Registry, client *sdk.IpGeolocationSDK) {
...
func runOp(client *sdk.IpGeolocationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
