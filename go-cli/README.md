...
AQL-driven CLI and REPL for the IpGeolocation SDK. Positional arguments are
...
./ip-geolocation-cli list get_ip_geolocation
./ip-geolocation-cli load 1 get_ip_geolocation
./ip-geolocation-cli load '{id:1}' get_ip_geolocation
