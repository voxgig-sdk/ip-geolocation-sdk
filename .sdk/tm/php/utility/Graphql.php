...
// IpGeolocation SDK utility: graphql
//
...
class IpGeolocationGraphql
{
    ...
    // equivalent.
    public static function body(IpGeolocationContext $ctx): mixed
    {
    ...
    public static function errors(IpGeolocationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
