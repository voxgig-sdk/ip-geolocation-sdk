...
// IpGeolocation SDK utility: fetcher

class IpGeolocationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IpGeolocationSDK/1.0)';
    ...
    public static function call(IpGeolocationContext $ctx, string $fullurl, array $fetchdef): array
    {
