...
// IpGeolocation SDK utility: make_options

class IpGeolocationMakeOptions
{
    ...
    public static function call(IpGeolocationContext $ctx): array
    {
        ...
        //
        // `IpGeolocationSchema::optspec()` is built from the model:
        ...
        $optspec = IpGeolocationSchema::optspec();
