...
// IpGeolocation SDK ratelimit feature
...
class IpGeolocationRatelimitFeature extends IpGeolocationBaseFeature
{
    ...
    private function _acquire(IpGeolocationContext $ctx): void
    {
    ...
    private function _track(IpGeolocationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
