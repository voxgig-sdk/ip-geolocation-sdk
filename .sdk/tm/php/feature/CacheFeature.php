...
// IpGeolocation SDK cache feature
...
class IpGeolocationCacheFeature extends IpGeolocationBaseFeature
{
    ...
    private function _through(IpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
