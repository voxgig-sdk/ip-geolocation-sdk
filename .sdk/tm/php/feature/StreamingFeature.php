...
// IpGeolocation SDK streaming feature
...
class IpGeolocationStreamingFeature extends IpGeolocationBaseFeature
{
    ...
    private function _iterate(IpGeolocationResult $result): \Generator
    {
    ...
    private function _streamable(IpGeolocationContext $ctx): bool
    {
