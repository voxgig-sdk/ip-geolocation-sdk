...
// IpGeolocation SDK rbac feature
...
class IpGeolocationRbacFeature extends IpGeolocationBaseFeature
{
    ...
    private function _required(IpGeolocationContext $ctx): ?string
    {
    ...
    private function _reject(IpGeolocationContext $ctx, string $required): void
    {
    ...
    private function _track(IpGeolocationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
