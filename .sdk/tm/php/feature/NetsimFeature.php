...
// IpGeolocation SDK netsim feature
...
class IpGeolocationNetsimFeature extends IpGeolocationBaseFeature
{
    ...
    private function _simulate(IpGeolocationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(IpGeolocationContext $ctx, array $applied): void
    {
        $client = $this->client;
