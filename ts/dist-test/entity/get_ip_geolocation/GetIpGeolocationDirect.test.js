...
(0, node_test_1.describe)('GetIpGeolocationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.IpGeolocationSDK({
    ...
    (0, node_test_1.test)('direct-load-get_ip_geolocation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_ip_geolocation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IP_GEOLOCATION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IpGeolocationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.IP_GEOLOCATION_APIKEY,
        }));
        let idmap = env['IP_GEOLOCATION_TEST_GET_IP_GEOLOCATION_ENTID'];
    ...
    const client = new __1.IpGeolocationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetIpGeolocationDirect.test.js.map