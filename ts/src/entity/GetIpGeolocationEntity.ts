...
class GetIpGeolocationEntity extends IpGeolocationEntityBase<GetIpGeolocation> {
  ...
  make(this: GetIpGeolocationEntity) {
    return new GetIpGeolocationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GetIpGeolocationLoadMatch, ctrl?: Control): Promise<GetIpGeolocationEntity> {
