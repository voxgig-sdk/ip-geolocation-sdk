...
#      offline in seeded test mode (IpGeolocationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "IpGeolocation_sdk.rb")
  SDK_CLASS = "IpGeolocationSDK"
