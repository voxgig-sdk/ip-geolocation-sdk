...
local GetIpGeolocationEntity = {}
GetIpGeolocationEntity.__index = GetIpGeolocationEntity


function GetIpGeolocationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetIpGeolocationEntity)
  self._name = "get_ip_geolocation"
  self._client = client
...
function GetIpGeolocationEntity:get_name()
  return self._name
end


function GetIpGeolocationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetIpGeolocationEntity.new(self._client, opts)
end
...
function GetIpGeolocationEntity:mark_deleted()
  self._deleted = true
end


function GetIpGeolocationEntity:deleted()
  return true == self._deleted
end


function GetIpGeolocationEntity:data_set(args)
  if args ~= nil then
...
function GetIpGeolocationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetIpGeolocationEntity:match_set(args)
  if args ~= nil then
...
function GetIpGeolocationEntity:match_get()
...
function GetIpGeolocationEntity:stream(action, args, callopts)
...
function GetIpGeolocationEntity:_run_op(ctx, post_done)
  local utility = self._utility
